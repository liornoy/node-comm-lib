module github.com/liornoy/main/node-comm-lib
...
require (
	...
	github.com/openshift/cluster-node-tuning-operator v0.0.0-20230928111805-0cd273508c42
	k8s.io/api v0.28.1
...
replace k8s.io/kubernetes => k8s.io/kubernetes v1.27.4
